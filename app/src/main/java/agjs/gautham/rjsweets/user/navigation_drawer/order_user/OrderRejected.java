...
public class OrderRejected extends AppCompatActivity {
    ...
    private void loadOrders(final String phone) {
        ...
        adapter = new FirebaseRecyclerAdapter<Request, OrderViewHolder>(
            ...
            protected void populateViewHolder(OrderViewHolder orderViewHolder, final Request request, final int i) {
                ...
                if (request.getStatus().equals("3")){
                    ...
                    orderViewHolder.orderStatusImage.setImageResource(R.drawable.rejected_stamp);
                    orderViewHolder.orderStatusImage.setScaleType(ImageView.ScaleType.CENTER_CROP);
                    orderViewHolder.bt_orderDetails.setTextColor(ContextCompat.getColor(OrderRejected.this, R.color.overlayBackground));
                    orderViewHolder.txtOrderId.setTextColor(ContextCompat.getColor(OrderRejected.this, R.color.overlayBackground));

                    orderViewHolder.bt_orderDetailsReason.setVisibility(View.VISIBLE);
                    orderViewHolder.orderDetailsReasonContainer.setVisibility(View.VISIBLE);
                    ...
                    orderViewHolder.deliveredStatus.setText("Rejected");
                    ...
                    orderViewHolder.bt_orderDetails.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent orderDetail = new Intent(OrderRejected.this, OrderDetail.class);
        ...
        if (String.valueOf(adapter.getItemCount()).equals("0")){
            ...
            textView.setVisibility(View.VISIBLE);
            textView.setText("Don't Panic! You Don't Have Any Order Rejected");
        }
